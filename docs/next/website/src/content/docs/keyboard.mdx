...
Press `prefix+w` to focus the expanded desktop sidebar. Herdr selects the currently focused pane in the workspace → tab → pane tree; if the sidebar is collapsed, it opens first.
