...
pub(super) struct ShellHitMap {
    ...
    pub(super) sidebar_tree_rows: Vec<(Rect, ClientNavigatorTarget)>,
...
pub(crate) struct ClientShellState {
    ...
    pub(super) sidebar_tree: super::sidebar_tree::SidebarTree,
...
impl ClientShellState {
    pub(crate) fn new(mut config: ClientShellConfig) -> Self {
        ...
        Self {
            ...
            sidebar_tree: super::sidebar_tree::SidebarTree::default(),
            overlay,
